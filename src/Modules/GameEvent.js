...
class GameEvent extends Component {
    constructor(props) {
        ...
        this.handleControler = this.handleControler.bind(this);
    }
    ...
    render() {
        return (
            <div>
                <div className='game_container' style={{backgroundPosition: '0' + this.state.position_road + "px"
                }}>
                    <div className='score'>{this.state.score}</div>
                    <div className='player'></div>

                </div>
                <input type="text" className='dieu_khien' id='dieu_khien'/>
            </div>
        );
    }
}
